...
class UtilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create utility" do
    assert_difference('Utility.count') do
      post utilities_url, params: { utility: { batch_number: @utility.batch_number, product_name: @utility.product_name, quantity: @utility.quantity } }
    end
  ...
  test "should update utility" do
    patch utility_url(@utility), params: { utility: { batch_number: @utility.batch_number, product_name: @utility.product_name, quantity: @utility.quantity } }
